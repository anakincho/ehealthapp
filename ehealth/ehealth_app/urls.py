...
urlpatterns = patterns('',
                       ...
                       url(r'^category/(?P<category_name_slug>[\w\-]+)/edit/$', views.edit_category,
                           name='edit_category'),
                       url(r'^delete_category/(?P<category_name_slug>[\w\-]+)$', views.delete_category,
                       ...
                       url(r'^check_cat/$', views.check_cat, name='check_cat'),
                       )
